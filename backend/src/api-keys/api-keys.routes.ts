...
/**
 * @route   PATCH /v1/auth/api-keys/:id
...
/**
 * @route   POST /v1/auth/api-keys/:id/disable
...
/**
 * @route   POST /v1/auth/api-keys/:id/enable
...
/**
 * @route   POST /v1/auth/api-keys/:id/toggle
...
/**
 * @route   POST /v1/auth/api-keys/:id/regenerate
...
/**
 * @route   DELETE /v1/auth/api-keys/:id
...
/**
 * @route   GET /v1/auth/api-keys/:id/logs
